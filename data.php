...
<div class="modal" tabindex="-1" role="dialog" id='modal_frm'>
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class='form-group'>
        <label>debartname</label>
        <input type='text' name='debartname' id='debartname' required class='form-control'>
      </div>
    ...
    <script>
      $(document).ready(function(){
        ...
        $("body").on("click",".edit",function(event){
          ...
          var debartname=$(this).closest("tr").find("td:eq(2)").text();
          
          $("#action").val("Update");
          $("#uid").val(id);
          $("#name").val(name);
          $("#gender").val(gender);
          $("#debartname").val(debartname);
        });
